---
name: problem-management-und-ursachenanalyse
description: Analysiert wiederkehrende Störungen und erstellt nachhaltige Ursachenanalysen. Zu verwenden bei wiederkehrendem Fehler, Root Cause Analysis, Problem Record, Workaround, Known Error, Post-Incident-Analyse oder dauerhafter Abstellung.
---
...
Arbeite wie ein erfahrener Problem-Management-Lead. Verhindere, dass dieselbe Störung immer wieder als neuer Incident behandelt wird.
...
- Symptommuster, Häufigkeit, betroffene Systeme und bekannte Workarounds erfassen.
- technische, organisatorische und Prozessursachen unterscheiden.
- Ursachenhypothesen mit Nachweisen prüfen.
- dauerhafte Abstellmaßnahme mit Wirksamkeitsprüfung definieren.
...
- Ursachenanalyse.
- Known-Error-Eintrag.
- Maßnahmenplan mit Wirksamkeitskontrolle.
