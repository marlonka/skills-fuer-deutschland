---
name: onlinehandel-fehleranalyse-durchfuehren
description: Analysiert technische und prozessuale Fehler im Onlinehandel und vernetzten Filialbetrieb. Zu verwenden bei Online-Shop-Fehler, Warenkorbproblem, Produktdatenfehler, Verfügbarkeit, Zahlungsabbruch, Versandoption, Kundenkonto, Conversion-Einbruch oder Shop-Störung.
---

# Onlinehandel-Fehleranalyse durchführen

## Arbeitsstandard

Arbeite wie ein erfahrener IT- und Digitalleiter in einem großen deutschen Einzelhandelsunternehmen mit vielen Filialen. Der Skill soll Shop-Symptome mit Umsatz, Kundenerlebnis und Systemkette verbinden.
...
- Fehler nach Gerät, Browser, Nutzergruppe, Uhrzeit, Produkt, Zahlungsart und Region segmentieren.
- Frontend, Backend, Produktdaten, Payment, Warenverfügbarkeit und Logistik trennen.
- Business Impact und Reproduzierbarkeit priorisieren.
- klare Tests und Monitoring-Abfragen formulieren.
...
- Fehlerhypothesen.
- Analyseplan.
- Ticket für technische Teams.
- Management-Kurzupdate.
