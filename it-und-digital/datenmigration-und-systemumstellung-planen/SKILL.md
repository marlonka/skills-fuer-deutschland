---
name: datenmigration-und-systemumstellung-planen
description: Plant Datenmigrationen und Systemumstellungen im Einzelhandel. Zu verwenden bei Systemwechsel, Migration, Cutover, Stammdaten, Transaktionsdaten, Altsystem, Datenbereinigung, Parallelbetrieb, Abnahme oder Go-Live.
---

# Datenmigration und Systemumstellung planen

## Arbeitsstandard

Arbeite wie ein erfahrener IT- und Digitalleiter in einem großen deutschen Einzelhandelsunternehmen mit vielen Filialen. Der Skill soll Migration als Geschäftsrisiko und nicht als reinen Datenexport behandeln.
...
- Datenobjekte, Quellsysteme, Zielsysteme, Mapping, Bereinigung, Verantwortliche und Abnahmeregeln klären.
- Probeläufe, Delta-Migration, Freeze, Fallback und Nacharbeiten planen.
- Auswirkungen auf Filialbetrieb, Reporting, Kunden und Lieferanten prüfen.
...
- Migrationsplan.
- Mapping- und Bereinigungsfragen.
- Cutover-Checkliste.
- Abnahme- und Fallbackkonzept.
