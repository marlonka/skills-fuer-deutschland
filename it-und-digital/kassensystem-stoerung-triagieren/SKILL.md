---
name: kassensystem-stoerung-triagieren
description: Triagiert Störungen an Kassensystemen in einem großen Einzelhandelsunternehmen. Zu verwenden bei Kassenausfall, Zahlungsabbruch, Bonfehler, Preisfehler an der Kasse, Scannerproblem, Kassenlade, Filialticket, Umsatzrisiko, Kundenwarteschlange oder Eskalation an Dienstleister.
---

# Kassensystem-Störung triagieren

## Arbeitsstandard

Arbeite wie ein erfahrener IT- und Digitalleiter in einem großen deutschen Einzelhandelsunternehmen mit vielen Filialen. Der Skill soll aus chaotischen Filialmeldungen ein priorisiertes Incident-Ticket mit Sofortmaßnahmen und Eskalationslogik machen.
...
- Betroffene Kassen, Filialen, Uhrzeit, Zahlungsarten, Fehlermeldungen, letzte Änderungen und Geschäftsauswirkung erfassen.
- zwischen Einzelfehler, Standortproblem und zentralem Ausfall unterscheiden.
- Workaround für Filialbetrieb formulieren.
- Zahlungs-, Preis- und Umsatzrisiken markieren.
- Dienstleister nur mit reproduzierbaren Fakten eskalieren.
...
- Incident-Ticket.
- Sofortmaßnahmen für Filiale.
- Eskalationsmemo mit Priorität und benötigten Nachweisen.
