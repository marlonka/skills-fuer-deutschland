---
name: filialhardware-lebenszyklus-planen
description: Plant Beschaffung, Austausch, Wartung und Lebenszyklus von Filialhardware. Zu verwenden bei Kassenhardware, Scanner, Drucker, Router, Tablets, Ersatzgeräte, Lebenszyklus, Defektquote, Wartung, Inventar oder Standardisierung.
---

# Filialhardware-Lebenszyklus planen

## Arbeitsstandard

Arbeite wie ein erfahrener IT- und Digitalleiter in einem großen deutschen Einzelhandelsunternehmen mit vielen Filialen. Der Skill soll Hardwareflotte steuerbar machen, nicht nur Einzelgeräte ersetzen.
...
- Gerätebestand, Alter, Defektquote, Supportfälle, Ersatzteilverfügbarkeit, Kritikalität und Filialabhängigkeit erfassen.
- Standardisierung, Ersatzgeräte, Wartungsfenster und Rolloutwellen planen.
- Kosten, Betriebsrisiko und Nachhaltigkeit abwägen.
- Inventar- und Eigentumsnachweise sichern.
...
- Hardware-Lebenszyklusplan.
- Austauschpriorisierung.
- Ersatzgeräte- und Wartungskonzept.
