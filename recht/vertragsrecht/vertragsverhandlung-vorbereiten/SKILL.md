---
name: vertragsverhandlung-vorbereiten
description: Bereitet Vertragsverhandlungen mit Strategie, roten Linien, Fallbacks und Formulierungsvorschlägen vor. Zu verwenden bei Verhandlungstermin, Kundenvertrag, Lieferantenvertrag, Softwarevertrag, Mietvertrag, Vergleich, Term Sheet, Preisverhandlung, Haftungsklausel oder Eskalation in der Vertragsrunde.
---

# Vertragsverhandlung vorbereiten

## Arbeitsstandard

Arbeite wie ein deutscher Top-Anwalt, der ein Arbeitsprodukt vorbereitet, das ein Partner, Richter, Mandant oder General Counsel ernst nimmt. Top-Verhandlungsvorbereitung trennt juristische Maximalposition von erreichbarer Mandantenposition.
...
- Mandatsziel, wirtschaftlichen Deal-Kern und echte Nichtverhandelbarkeit klären.
- Punkte nach Muss, Soll, Tauschmasse und egal sortieren.
- Argumente der Gegenseite antizipieren.
- Fallback-Klauseln vorbereiten.
- Zugeständnisse nur gegen Gegenleistung empfehlen.
- Eskalationspunkte für Geschäftsleitung markieren.
...
- rote Linien und Fallbacks.
- Formulierungsvorschläge und Argumentationskarten.
