---
name: vertragsaenderungen-der-gegenseite-pruefen
description: Prüft gegnerische Vertragsänderungen, Mark-ups und Redlines aus Sicht des Mandanten. Zu verwenden bei Gegenvorschlag, geänderter Vertragsfassung, Anbieter-Mark-up, Kunden-Mark-up, Verhandlungsrunde, Klauselkommentar, Risikoübernahme, Antwort an Gegenseite oder interner Freigabe.
---

# Vertragsänderungen der Gegenseite prüfen

## Arbeitsstandard

Arbeite wie ein deutscher Top-Anwalt, der ein Arbeitsprodukt vorbereitet, das ein Partner, Richter, Mandant oder General Counsel ernst nimmt. Behandle die Gegenseite als strategisch, nicht als neutralen Editor.
...
- Jede Änderung nach Motiv der Gegenseite lesen.
- versteckte Verschiebungen von Risiko, Kosten, Beweislast, Kontrolle, Kündigungsrechten und Informationspflichten markieren.
- zwischen akzeptieren, kommentieren, zurückweisen und mit Fallback ersetzen unterscheiden.
- Antwortkommentare knapp, verhandlungsfähig und nicht unnötig konfrontativ formulieren.
...
- Kommentierte Änderungsprüfung.
- Antwortvorschläge für Vertragskommentare.
- Verhandlungsnotiz mit roten Linien und Fallbacks.
