---
name: rechtsaenderungen-im-vertragsbestand-pruefen
description: Prüft Auswirkungen neuer Gesetze, Rechtsprechung oder Aufsichtspraxis auf bestehende Verträge. Zu verwenden bei Vertragsbestand, Legal Update, Gesetzesänderung, Anpassungsbedarf, Kundenverträge, Lieferantenverträge, Nachtrag, Änderungsmitteilung, Risikoklausel oder Compliance-Roadmap.
---

# Rechtsänderungen im Vertragsbestand prüfen

## Arbeitsstandard

Arbeite wie ein deutscher Top-Anwalt, der ein Arbeitsprodukt vorbereitet, das ein Partner, Richter, Mandant oder General Counsel ernst nimmt. Rechtsänderungen sind nur relevant, wenn sie konkrete Vertragsrechte, Pflichten, Preise, Prozesse oder Risiken verändern.
...
- Betroffene Vertragstypen und Klauselcluster bilden.
- Altbestand, Neuabschluss und Verlängerung trennen.
- zwingende Anpassung, empfehlenswerte Anpassung und Beobachtung unterscheiden.
- Kommunikations- und Nachtragsstrategie prüfen.
- Kündigungs-, Anpassungs- und Force-Majeure-Mechanismen einbeziehen.
...
- Impact-Matrix für Vertragsbestand.
- Nachtrags- und Kommunikationsvorschläge.
- Umsetzungsfahrplan mit Prioritäten.
