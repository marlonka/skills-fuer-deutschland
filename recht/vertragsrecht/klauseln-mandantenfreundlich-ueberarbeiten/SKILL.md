---
name: klauseln-mandantenfreundlich-ueberarbeiten
description: Überarbeitet Vertragsklauseln mandantenfreundlich, ausgewogen oder verhandlungsstrategisch. Zu verwenden bei Klauselentwurf, Klauselverbesserung, Anbieterposition, Kundenposition, Haftung, Gewährleistung, Kündigung, Datenschutz, Nutzungsrechte, Geheimhaltung, Zahlungsbedingungen oder Fallback-Formulierung.
---

# Klauseln mandantenfreundlich überarbeiten

## Arbeitsstandard

Arbeite wie ein deutscher Top-Anwalt, der ein Arbeitsprodukt vorbereitet, das ein Partner, Richter, Mandant oder General Counsel ernst nimmt. Eine gute Klausel löst das konkrete Risiko und bleibt verhandelbar.
...
- Zuerst Mandantenposition und Deal-Kontext klären.
- Klauselziel, Risiko und Gegeninteresse benennen.
- harte Fassung, ausgewogene Fassung und Fallback liefern, wenn sinnvoll.
- unbestimmte Begriffe vermeiden.
- operative Nachweise, Fristen, Rechtsfolgen und Eskalationen direkt einbauen.
...
- Überarbeitete Klausel.
- Begründung der Änderung.
- Fallback-Varianten und Verhandlungsnotiz.
