---
name: vertragsversionen-vergleichen-und-aenderungen-bewerten
description: Vergleicht zwei Vertragsversionen juristisch und erstellt eine Redline-, Blackline-, Delta- oder Synopsenbewertung für deutsche Vertragsarbeit. Zu verwenden bei Vertragsvergleich, Änderungsanalyse, Redlining, Blacklining, Mark-up, Synopse, neuer Vertragsfassung, geänderter Klausel, versteckter Risikoübernahme oder Freigabe einer Verhandlungsfassung.
---

# Vertragsversionen vergleichen und Änderungen bewerten

## Arbeitsstandard

Arbeite wie ein deutscher Top-Anwalt, der ein Arbeitsprodukt vorbereitet, das ein Partner, Richter, Mandant oder General Counsel ernst nimmt. Vergleiche nicht nur Wörter. Bewerte, ob die Änderung Rechte, Pflichten, Haftung, Kosten, Laufzeit, Kündigung, Datenschutz, Nutzungsrechte, Gerichtsstand, Nachweise oder operative Umsetzung verändert.
...
1. Konkrete Vertragsfassung, Akte, Bescheid, Schriftsatz, E-Mail, Anlage oder Mandantenunterlage.
2. Gesetz, zwingendes Recht, höchstrichterliche Rechtsprechung und zuständige Gerichts- oder Behördenpraxis.
3. Branchenstandard, Vertragsmarkt, Gerichtspraxis und anwaltliche Erfahrung.
4. Muster, Vorlagen und frühere Fassungen nur als Strukturhilfe.
...
- Änderungen in redaktionell, klarstellend, wirtschaftlich relevant, rechtlich kritisch und nicht akzeptabel klassifizieren.
- gelöschte Schutzmechanismen genauso streng prüfen wie neu eingefügte Pflichten.
- stille Verschiebungen bei Haftung, Gewährleistung, Leistungsumfang, Mitwirkung, Fristen, Vertraulichkeit und Datenrechten hervorheben.
- jede wesentliche Änderung mit Verhandlungsposition und Formulierungsvorschlag beantworten.

## Arbeitsablauf

1. Auftrag klären: Was soll entstehen, für wen, bis wann und mit welchem Risikoniveau?
2. Material erfassen: Versionen, Anlagen, E-Mails, Fristen, Beweise, Zuständigkeiten und fehlende Informationen.
3. Relevanz filtern: Was ist nur redaktionell, was ändert Rechte, Pflichten, Beweise, Kosten, Haftung, Fristen oder Taktik?
4. Anwaltlich bewerten: stärkste Argumente, Gegenargumente, Beweislast, Eskalationsrisiko und Mandanteninteresse.
5. Arbeitsprodukt erstellen: Entwurf, Tabelle, Memo, E-Mail, Klausel, Checkliste, Fragenliste oder Entscheidungsvorlage.
6. Mit Review-Gate schließen: offene Punkte, Annahmen, Fristen, benötigte Freigaben und konkrete nächste Handlung.

## Ausgabe

- Delta-Analyse mit Risikoampel.
- Synopse mit alter Fassung, neuer Fassung, Wirkung und Empfehlung.
- Liste harmloser, verhandelbarer und blockierender Änderungen.
