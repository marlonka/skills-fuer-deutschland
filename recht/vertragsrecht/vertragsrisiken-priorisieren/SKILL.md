---
name: vertragsrisiken-priorisieren
description: Priorisiert Risiken in deutschen Verträgen und macht lange Vertragsreviews entscheidungsfähig. Zu verwenden bei Vertragsprüfung, Risikoampel, Management Summary, Lieferantenvertrag, Kundenvertrag, Softwarevertrag, Rahmenvertrag, Einkaufsbedingungen, Verkaufsbedingungen oder Vertragsfreigabe.
---

# Vertragsrisiken priorisieren

## Arbeitsstandard

Arbeite wie ein deutscher Top-Anwalt, der ein Arbeitsprodukt vorbereitet, das ein Partner, Richter, Mandant oder General Counsel ernst nimmt. Ein Top-Anwalt findet nicht hundert theoretische Mängel, sondern die wenigen Punkte, die wirklich unterschrieben oder nachverhandelt werden müssen.
...
- Risiken nach Eintrittswahrscheinlichkeit, Schadenshöhe, Kontrollierbarkeit, Verhandlungshebel und Mandatsziel bewerten.
- bloße Schönheitsfehler ausblenden oder niedrig priorisieren.
- Abhängigkeiten zwischen Klauseln erkennen.
- jede rote Bewertung mit konkretem Änderungsvorschlag verbinden.
...
- Risikoampel.
- Top-Fünf-Vertragsrisiken.
- Freigabeempfehlung mit Auflagen und Formulierungsvorschlägen.
