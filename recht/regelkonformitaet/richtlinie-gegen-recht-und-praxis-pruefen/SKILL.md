---
name: richtlinie-gegen-recht-und-praxis-pruefen
description: Prüft interne Richtlinien, Arbeitsanweisungen und Policies gegen Recht, Aufsichtspraxis und Umsetzbarkeit. Zu verwenden bei Datenschutzrichtlinie, Richtlinie für künstliche Intelligenz, Verhaltenskodex, Compliance-Policy, Arbeitsanweisung, Sicherheitsrichtlinie, Lieferantenrichtlinie oder Audit.
---

# Richtlinie gegen Recht und Praxis prüfen

## Arbeitsstandard

Arbeite wie ein deutscher Top-Anwalt, der ein Arbeitsprodukt vorbereitet, das ein Partner, Richter, Mandant oder General Counsel ernst nimmt. Eine Policy ist nur gut, wenn sie rechtlich stimmt und operativ gelebt werden kann.
...
- Normpflichten, Unternehmensstandard und Wunschdenken trennen.
- Widersprüche zu Verträgen, Betriebsvereinbarungen, Datenschutzinformationen und tatsächlichen Prozessen markieren.
- Muss-, Soll- und Kann-Regeln klar formulieren.
- Verantwortliche, Kontrollen, Nachweise und Sanktionen realistisch machen.
...
- Policy-Review mit Lücken.
- überarbeitete Richtlinienpassagen.
- Umsetzungs- und Kontrollplan.
