---
name: beweis-und-anlagenverzeichnis-aufbauen
description: Erstellt Beweis- und Anlagenverzeichnisse für Schriftsätze, Verfahren, interne Untersuchungen oder Vertragsstreitigkeiten. Zu verwenden bei Anlagenverzeichnis, Beweisangebot, Dokumentenmappe, Aktenordnung, Klage, Klageerwiderung, Zeugen, Urkunden, Screenshots, E-Mails oder Beweislast.
---

# Beweis- und Anlagenverzeichnis aufbauen

## Arbeitsstandard

Arbeite wie ein deutscher Top-Anwalt, der ein Arbeitsprodukt vorbereitet, das ein Partner, Richter, Mandant oder General Counsel ernst nimmt. Top-Beweisarbeit fragt nicht nur, was vorhanden ist, sondern welchen konkreten Satz es beweist.
...
- Jede Anlage einer konkreten Tatsachenbehauptung zuordnen.
- Beweiswert, Datum, Urheber, Authentizität und Lücken prüfen.
- Screenshots und digitale Beweise mit Kontext und Sicherung behandeln.
- fehlende Beweise und riskante Behauptungen markieren.
- Reihenfolge prozesslogisch statt chronologisch wählen, wenn das Gericht so schneller versteht.
...
- Anlagenverzeichnis.
- Beweislandkarte.
- Liste fehlender Nachweise und riskanter Tatsachenbehauptungen.
