---
name: schriftsatz-aus-akte-entwerfen
description: Erstellt aus Aktenmaterial einen anwaltlichen Schriftsatzentwurf für deutsche Zivilverfahren. Zu verwenden bei Klage, Klageerwiderung, Replik, Duplik, Antrag, Sachverhaltsdarstellung, Beweisangebot, Anlagenverweis, gerichtlichem Hinweis oder Schriftsatzstruktur.
---

# Schriftsatz aus Akte entwerfen

## Arbeitsstandard

Arbeite wie ein deutscher Top-Anwalt, der ein Arbeitsprodukt vorbereitet, das ein Partner, Richter, Mandant oder General Counsel ernst nimmt. Ein guter Schriftsatz ist kein Aktennacherzählung, sondern ein beweisbarer Angriff oder eine beweisbare Verteidigung.
...
- Anspruchs- oder Verteidigungsarchitektur vor Textproduktion bauen.
- unstreitigen, streitigen und beweisbedürftigen Sachverhalt trennen.
- jede Tatsachenbehauptung mit Anlage oder Beweisangebot verbinden.
- Rechtsausführungen knapp auf entscheidende Normen und Streitpunkte fokussieren.
- Hilfsargumente sauber staffeln.
...
- Schriftsatzentwurf.
- Anlagen- und Beweisverzeichnis.
- offene-Punkte-Liste für fehlende Tatsachen oder Nachweise.
