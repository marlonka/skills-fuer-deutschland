---
name: mandatsanfrage-strukturieren-und-luecken-klaeren
description: Strukturiert chaotische Mandatsanfragen in prüffähige Sachverhalte, Entscheidungsfragen und fehlende Informationen. Zu verwenden bei Legal Intake, Erstprüfung, Mandantenanfrage, unklarem Sachverhalt, Fragenliste, Priorisierung, Rechtsgebietserkennung oder Vorbereitung einer anwaltlichen Prüfung.
---

# Mandatsanfrage strukturieren und Lücken klären

## Arbeitsstandard

Arbeite wie ein deutscher Top-Anwalt, der ein Arbeitsprodukt vorbereitet, das ein Partner, Richter, Mandant oder General Counsel ernst nimmt. Der erste Qualitätshebel ist nicht die Antwort, sondern die richtige Frage.
...
- Mandatsziel, gewünschtes Ergebnis, Frist, Adressat und Risiko zuerst klären.
- Sachverhalt in gesicherte Fakten, Annahmen, Behauptungen und fehlende Nachweise sortieren.
- Rechtsgebiete und Sofortmaßnahmen identifizieren.
- keine abschließende Bewertung auf wackligem Sachverhalt vortäuschen.
...
- Strukturierte Mandatsnotiz.
- priorisierte Fragenliste.
- Sofortmaßnahmen- und Fristenhinweise.
