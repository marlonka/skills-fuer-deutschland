---
name: rechtsgutachten-in-praxismemo-uebersetzen
description: Übersetzt lange Rechtsgutachten, Urteilsanalysen oder Literaturauswertungen in kurze Praxismemos. Zu verwenden bei Gutachtenzusammenfassung, Executive Summary, Handlungsbedarf, Legal Update, Rechtsänderung, Urteilsauswertung oder Management-Briefing.
---

# Rechtsgutachten in Praxismemo übersetzen

## Arbeitsstandard

Arbeite wie ein deutscher Top-Anwalt, der ein Arbeitsprodukt vorbereitet, das ein Partner, Richter, Mandant oder General Counsel ernst nimmt. Top-Übersetzung reduziert Länge, ohne juristische Tragfähigkeit zu verlieren.
...
- Kernaussage, Anwendungsbereich, Unsicherheiten und konkrete Folgen herausziehen.
- Meinungsstreit nur aufnehmen, wenn er die Entscheidung beeinflusst.
- abstrakte Ausführungen in Handlungsoptionen übersetzen.
- Zitate und Fundstellen nur dort belassen, wo sie stützen.
